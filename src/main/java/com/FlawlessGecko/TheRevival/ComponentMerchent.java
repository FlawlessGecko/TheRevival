...
public static House1 buildComponent(Start villagePiece, List pieces, Random random, int p1, int p2, int p3, int p4, int p5) {
StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p1, p2, p3, 0, 0, 0, 10, 6, 10, p4);
return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(pieces, structureboundingbox) == null ? new StructureVillagePieces.House1() : null;}
...
this.placeBlockAtCurrentPosition(world, ModBlocks.blockbrick, 0, 4, 0, 7, sbb);
